...
pub use retriever::{
    Bm25Index, EMBEDDING_DIM, add_specs_to_index, build_embedding_index, clear_index,
    cosine_similarity, generate_embedding, get_index_stats, hybrid_search, reciprocal_rank_fusion,
    retrieve_relevant_specs, retrieve_with_domain_filter,
};
