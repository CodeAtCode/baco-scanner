...
pub async fn run_semgrep(
    ...
    pb.set_message("Phase 2/24: Running Semgrep static analysis (scanning for known vulnerability patterns)...");
        ...
        .await
    {
        Ok(semgrep_findings) => {
            ...
            pb.set_message(format!(
                "Phase 2/24: Semgrep complete - {} findings discovered",
                semgrep_count
            ));
        ...
        Err(e) => {
            ...
            pb.set_message("Phase 2/24: Semgrep failed - skipping phase");
            pb.set_position(pb.position() + 100);
