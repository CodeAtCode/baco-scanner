...
fn test_severity_mapping_table_completeness() {
    ...
    // Boundaries per RubricScore::map_to_severity: >=0.8 Critical, >=0.5 High, >=0.2 Medium, else Low
    let test_cases = vec![
        (0.0, V3Severity::Low),
        (0.19, V3Severity::Low),
        (0.2, V3Severity::Medium),
        (0.25, V3Severity::Medium),
        (0.49, V3Severity::Medium),
        (0.5, V3Severity::High),
        (0.75, V3Severity::High),
        (0.79, V3Severity::High),
        (0.8, V3Severity::Critical),
