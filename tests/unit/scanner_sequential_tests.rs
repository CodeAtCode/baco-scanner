...
// Now using PhaseSpec as the single source of truth
// ============================================================================
...
#[test]
fn test_progress_messages_all_non_empty() {
...
#[test]
fn test_progress_messages_known_values() {
    assert_eq!(
