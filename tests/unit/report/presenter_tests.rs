...
#[test]
fn test_format_confidence_percentage_extreme_values() {
    assert_eq!(format_confidence_percentage(0.001), "0.1%");
    assert_eq!(format_confidence_percentage(0.999), "99.9%");
}

#[test]
fn test_format_confidence_percentage_precision() {
    assert_eq!(format_confidence_percentage(0.1234), "12.3%");
    assert_eq!(format_confidence_percentage(0.5678), "56.8%");
}

#[test]
fn test_format_confidence_percentage_negative() {
    // Negative values are technically possible in f64
    assert_eq!(format_confidence_percentage(-0.1), "-10.0%");
}

#[test]
fn test_format_confidence_percentage_very_large() {
    // Values > 1.0 are technically possible
    assert_eq!(format_confidence_percentage(1.5), "150.0%");
}
...
#[test]
fn test_format_confidence_int_percentage_extreme_values() {
    assert_eq!(format_confidence_int_percentage(0.001), "0%");
    assert_eq!(format_confidence_int_percentage(0.999), "100%");
}

#[test]
fn test_format_confidence_int_percentage_precision() {
    assert_eq!(format_confidence_int_percentage(0.1234), "12%");
    assert_eq!(format_confidence_int_percentage(0.5678), "57%");
}
...
#[test]
fn test_severity_ordering_all_classes_distinct() {
    let classes = [
    ...
    // All severity classes should be unique
