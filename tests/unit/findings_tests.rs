...
//! VulnerabilityFinding, SecurityIssue, FindingsMerger

use baco::findings::{
    FindingsMerger, IssueCategory, SecurityIssue, Severity, TriageVerdict, VerificationStatus,
...
// ============================================================================
// FindingsMerger Tests
// ============================================================================

#[test]
fn test_findings_merger_new() {
    let merger = FindingsMerger::new();
    let findings = merger.into_findings();
    assert!(findings.is_empty());
}

#[test]
fn test_findings_merger_default() {
    let merger = FindingsMerger::default();
    let findings = merger.into_findings();
    assert!(findings.is_empty());
}

#[test]
fn test_findings_merger_merge_single_finding() {
    ...
    merger.merge(vec![finding.clone()]);
    let findings = merger.into_findings();
    assert_eq!(findings.len(), 1);
    assert_eq!(findings[0].id, "unique-id");
}

#[test]
fn test_findings_merger_deduplicates_by_id() {
    let mut merger = FindingsMerger::new();
...
#[test]
fn test_findings_merger_merge_multiple_unique() {
    let mut merger = FindingsMerger::new();
    ...
    merger.merge(vec![finding1, finding2]);
    let findings = merger.into_findings();
    assert_eq!(findings.len(), 2);
}

#[test]
fn test_findings_merger_merge_scans_single_scan() {
    let scan1 = vec![
        VulnerabilityFinding {
            id: "scan1-id1".to_string(),
            title: "Scan1-1".to_string(),
            description: "Desc".to_string(),
            severity: Severity::Low,
        ...
        VulnerabilityFinding {
            id: "scan1-id2".to_string(),
            title: "Scan1-2".to_string(),
            description: "Desc".to_string(),
            severity: Severity::Low,
            confidence_score: 0.3,
            cwe_id: None,
    ...
    let merged = FindingsMerger::merge_scans(vec![scan1]);
    assert_eq!(merged.len(), 2);
}

#[test]
fn test_findings_merger_merge_scans_multiple_scans_no_duplicates() {
    let scan1 = vec![VulnerabilityFinding {
        id: "scan1-id".to_string(),
        title: "Scan1".to_string(),
        description: "Desc".to_string(),
        severity: Severity::Low,
        confidence_score: 0.3,
        cwe_id: None,
    ...
    let scan2 = vec![VulnerabilityFinding {
        id: "scan2-id".to_string(),
        title: "Scan2".to_string(),
        description: "Desc".to_string(),
        severity: Severity::Low,
        confidence_score: 0.3,
        cwe_id: None,
...
#[test]
fn test_findings_merger_merge_scans_deduplicates_across_scans() {
    let scan1 = vec![VulnerabilityFinding {
        id: "shared-id".to_string(),
        title: "Shared-1".to_string(),
        description: "Desc".to_string(),
        severity: Severity::High,
        confidence_score: 0.8,
        cwe_id: None,
    ...
    let scan3 = vec![VulnerabilityFinding {
        id: "unique-id".to_string(),
    ...
    assert_eq!(merged.len(), 2);
    assert_eq!(merged[0].title, "Shared-1");
    assert_eq!(merged[1].title, "Unique");
}

#[test]
fn test_findings_merger_merge_scans_empty_input() {
    let merged = FindingsMerger::merge_scans(vec![]);
    assert!(merged.is_empty());
}

#[test]
fn test_findings_merger_merge_scans_empty_scans() {
    let merged = FindingsMerger::merge_scans(vec![vec![], vec![], vec![]]);
    assert!(merged.is_empty());
}
