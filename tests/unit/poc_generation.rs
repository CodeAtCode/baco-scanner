...
fn test_generate_sql_injection_poc() {
    let engine = PoCGenerationEngine::new();
    let finding = create_test_finding_inline("CWE-89");
    let context = AnalysisContext::default();
...
fn test_generate_command_injection_poc() {
    let engine = PoCGenerationEngine::new();
    let finding = create_test_finding_inline("CWE-78");
    let context = AnalysisContext::default();
    ...
    assert!(!result.proofs.is_empty());
    assert!(
        result.proofs[0].code.contains("system") || result.proofs[0].code.contains("subprocess")
    );
}
...
fn test_generate_xss_poc() {
    let engine = PoCGenerationEngine::new();
    let finding = create_test_finding_inline("CWE-79");
    let context = AnalysisContext::default();
...
fn test_generate_rust_poc() {
    let engine = PoCGenerationEngine::new();
    let finding = create_test_finding_inline("CWE-121");
    let context = AnalysisContext::default();
...
fn test_unknown_cwe() {
    let engine = PoCGenerationEngine::new();
    let finding = create_test_finding_inline("CWE-999");
    let context = AnalysisContext::default();
...
fn test_low_severity_filtered() {
    let engine = PoCGenerationEngine::new();
    let mut finding = create_test_finding_inline("CWE-89");
...
// ============================================================================
// Inline test helper (migrated from src/poc_generation.rs)
// ============================================================================

fn create_test_finding_inline(cwe_id: &str) -> VulnerabilityFinding {
