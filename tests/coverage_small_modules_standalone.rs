//! Standalone coverage tests for small modules: eval, error, config/knowledge, agent_flow/executor, rulesynth/proposer
//! This is a separate test binary to avoid compilation errors in other test files.
...
impl LlmChatClient for MockLlm {
